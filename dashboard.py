...
def main():
    ...
    with st.sidebar:
        ...
        page = st.selectbox(
            "Select Page:",
            ["📊 Overview", "📈 Time Analytics", "📊 Status Analysis", "🎯 Advanced Analytics", "💼 Proposal Tracking", "📈 Business Plan", "🧪 Experiments", "🧮 Formulas", "📊 Chart Builder"]
        )
    ...
    if page == "📊 Overview":
        # Initialize analytics engines for overview
